...
const data = [
  {
    ...
    tag: "Newsletter",
    description:
      "Editorial weekly digest with hero story , numbered story, tip of the week , tools section and community poll.",
  ...
  },
  {
    ...
    tag: "Onboarding",
    description:
      "Welcome email for a local services directory featuring a navy hero, 3-column category grid,numbered how-it-works steps and a testimonial.",
  ...
  },
  {
    ...
    tag: "Transactional",
    description:
      "Order confirmation email with product line items,mj-table order summary, delivery date banner,upsell grid and a full dark theme.",
  ...
  },
  {
    ...
    tag: "Promotional",
    description:
      "High-energy Black Friday promo with static countdown timer, 2x2 product deal grid,featured deal spotlight and urgency strip.",
  ...
  },
  {
    ...
    tag: "Security",
    description:
      "Minimal password reset email with a single CTA, security info cards, warning box,fallback URL and one-font clean layout.",
    tags: ["Minimal", "Single Focus", "Light theme"],
    techStack: "MJML",
    link: "https://emaildeveloper.netlify.app/vaultly/password-reset-email",
  },
  {
    image: "images/donor_appeal.png",
  ...
  {
    image: "images/monthly_newsletter.png",
